component {
    ...
    VARIABLES.reader  = createObject("java","org.apache.pdfbox.pdmodel.PDDocument",  "lib/pdfbox/pdfbox-app-2.0.4.jar");
    VARIABLES.fdf  = createObject("java","org.apache.pdfbox.pdmodel.fdf.FDFDocument",  "lib/pdfbox/pdfbox-app-2.0.4.jar");
